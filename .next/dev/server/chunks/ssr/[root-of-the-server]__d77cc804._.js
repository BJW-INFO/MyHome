...
;
const useAuth = ()=>{
    const password = __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$custemStorage$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["custemStorage"].local.get(`auth`, ``);
    ...
    /**API로 password를 보내 확인하기*/ const authPath = async (pw)=>{
        ...
        try {
            ...
            if (response.status === 200) {
                __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$custemStorage$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["custemStorage"].local.set(`auth`, pw);
                setAuth(true);
            }
        } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d77cc804._.js.map