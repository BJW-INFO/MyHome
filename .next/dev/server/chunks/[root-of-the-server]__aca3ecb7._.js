...
const lostArkApi = {
    init: async ()=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].get(`${process.env.LOSTARK_API_BASE}/exmaple/api`, {
                headers: {
    ...
    calendar: async ()=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].get(`${process.env.LOSTARK_API_BASE}/gamecontents/calendar`, {
                headers: {
                    Accept: "application/json",
                    Authorization: `bearer ${process.env.LOSTARK_API_KEY}`
                }
...
async function GET(req) {
    ...
    try {
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$props$2e$tsx__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CustomResponse"])(api);
    } catch (e) {}
}
}),
        ...
        const setScheduler = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$props$2e$tsx__$5b$app$2d$route$5d$__$28$ecmascript$29$__["scheduler"])({
            ...
            updated: async ({ contents, category })=>{
                try {
                    ...
                    for (const content of contents){
                        if (events.find((event)=>event.Title === content.etc.title)) {
                            const end = today.isAfter((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$dayjs$2f$dayjs$2e$min$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(content.end).tz('Asia/Seoul'), `day`);
                            duplications[end ? 'delete' : 'update'].push(content);
                        }
                    }
                    for (const [action, content] of Object.entries(duplications)){
                        const arry = content.map((content)=>content.id);
                        await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$props$2e$tsx__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].rpc(`${action}_loa_event_contents`, {
                            p_parents: arry,
                            ...action === 'update' ? {
                                p_is_clear: false
                            } : {}
                    ...
                    for (const event of events){
                        if (duplications.update.find((content)=>content.etc.title === event.Title)) {
                            continue;
                        }
                        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$props$2e$tsx__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].rpc(`insert_loa_event_contents`, {
                            p_category: category,
                            p_etc: {
                                title: event.Title,
                                img: event.Thumbnail,
            ...
            callback: async ({ contents })=>{
                let result = [];
                for (const content of contents){
                    const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$props$2e$tsx__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('contents').select('id, etc, profiles:profile(*)').eq('parent', content.id);
                    const sortedData = data ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$loa$2f$props$2e$tsx__$5b$app$2d$route$5d$__$28$ecmascript$29$__["contentsSort"])(data, `profiles`) : [];
                    result.push({
                        ...content,
...
async function POST(req) {
    ...
    try {
        ...
        const category = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$props$2e$tsx__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCategories"])('LOA', 'EVENT_ACTIVE');
        const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$props$2e$tsx__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('profiles').select('id').eq('type', 'LOA').eq(`character`, 0).neq('account', '');
        const { error: initError } = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$props$2e$tsx__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].rpc(`insert_contents`, {
            p_category: category,
            p_parent: contents,
...
async function DELETE(req) {
    ...
    try {
        ...
        const category = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$props$2e$tsx__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCategories"])('LOA', 'EVENT_ACTIVE');
        const { error: deleteError } = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$props$2e$tsx__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].rpc(`delete_parent_contents`, {
            p_category: category,
            p_parent: content
        });
        if (deleteError) {
...
async function PUT(req) {
    ...
    try {
        ...
        const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$props$2e$tsx__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('contents').select('etc').eq('id', id).single();
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$props$2e$tsx__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('contents').update({
            etc: {
                ...data?.etc,
                is_clear: !data?.etc.is_clear
            }
        }).eq('id', id);
        if (error) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$props$2e$tsx__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CustomError"]('loa/event => update error', error, 500);
        }
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$props$2e$tsx__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CustomResponse"])();
    } catch (e) {
        console.log('loa/event => insert error:', e.error);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__aca3ecb7._.js.map