    ...
    try {
        const setScheduler = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$props$2e$tsx__$5b$app$2d$route$5d$__$28$ecmascript$29$__["scheduler"])({
            ...
            callback: async ({ contents })=>{
                let result = [];
                for (const content of contents){
                    const { data: obj } = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$props$2e$tsx__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('contents').select('id, etc, profiles:profile(*)').eq('parent', content.id);
                    console.log(obj);
                    result.push({
                        ...content,
                        profile: obj ?? []
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ee201b55._.js.map